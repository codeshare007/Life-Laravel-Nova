...
/**
 * @OA\Schema(
 *     schema="BlendCollectionResource2.1",
 *     description="Collection of ailments response",
 *     type="object",
 *     title="Blend Collection Resource V2.1",
 *     @OA\Property(
 *          property="data",
 *           @OA\Schema(
 *             type="array",
 *             @OA\Items(ref="#/components/schemas/BlendResource2.1")
 *         ),
 *     ),
 *     @OA\Property(
 ...
 * )
 */
class BlendResourceCollection extends ResourceCollection
{
    /**
