...
namespace App\Http\Controllers\Api\v2_1\Supplement;
...
class SupplementController extends BaseQueryBuilderController
{
    /**
     * @var Supplement
     */
    ...
    /**
     * SupplementController constructor.
     *
    ...
    public function __construct(
        ...
        parent::__construct($supplement, $request, $this->allowedIncludes);
    }

    /**
     * @OA\Get(
     *     path="/{lang}/v2.1/supplements",
     *     description="Fetch all supplements with given relationships",
     *     tags={"V2.1-api-auth"},
     *     @OA\Parameter(
     *         name="lang",
     *         in="path",
     ...
     *         @OA\JsonContent(
     *             type="array",
     *             @OA\Items(ref="#/components/schemas/SupplementCollectionResource2.1")
     *         ),
     *     ),
     *     @OA\Response(
     *         response=400,
    ...
    {
        if (! Cache::has(ElementCacheKey::Supplement)) {
            Cache::forever(
                ElementCacheKey::Supplement,
        ...
        $data = Cache::get(ElementCacheKey::Supplement);

        return api_resource(ApiCollectionResource::Supplement)
            ->make($data);
    }
}
