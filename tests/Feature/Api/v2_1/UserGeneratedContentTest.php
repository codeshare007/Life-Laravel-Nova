...
class UserGeneratedContentTest extends TestCase
{
    ...
    public function test_user_can_add_content()
    {
        ...
        $response = $this->json('POST', route('api.v2_1_ugc.store', 'en'), $userGeneratedContent->toArray());
    ...
    public function test_user_can_delete_own_private_content()
    {
        ...
        $response = $this->json('DELETE', route('api.v2_1_ugc.destroy', ['en', $userGeneratedContent->uuid]));
    ...
    public function test_user_can_update_own_content()
    {
        ...
        $response = $this->json('PUT', route('api.v2_1_ugc.update', ['en', $userGeneratedContent->uuid]), $updatedData);
    ...
    {
        $response = $this->json('GET', route('api.v2_1_ugc.index', 'en'));
        $response->assertStatus(401);
    }

    public function test_user_can_see_all_own_content()
    {
        $this->signIn();
        $nb = 10;
        factory(UserGeneratedContent::class, $nb)->create();
        $response = $this->json('GET',  route('api.v2_1_ugc.index', 'en'));

        $response->assertStatus(200);
        $this->assertEquals($nb, UserGeneratedContent::count());
    }
    ...
    public function test_user_can_see_own_content()
    {
        $this->signIn();
        $userGeneratedContent = factory(UserGeneratedContent::class)->create();
        $response = $this->json('GET', route('api.v2_1_ugc.show', ['en', $userGeneratedContent->uuid]));
    ...
    public function test_user_can_add_content_with_image()
    {
        ...
        $response = $this->json('POST',  route('api.v2_1_ugc.store', 'en'), [
