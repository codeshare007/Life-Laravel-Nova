...
class CreateAilmentRelatedBodySystemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ailment_related_body_system', function (Blueprint $table) {
            // Foreign keys
    ...
    {
        Schema::dropIfExists('ailment_related_body_system');
    }
}
