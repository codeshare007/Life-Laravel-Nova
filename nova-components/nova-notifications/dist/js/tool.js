...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NotificationsCard__ = __webpack_require__(17);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_IconSuccess__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__icons_IconFailed__ = __webpack_require__(14);
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v(_vm._s(_vm.__("Nova Notifications")))
      ]),
      _vm._v(" "),
      _c(
        "loading-card",
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NotificationsParamModal__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(40);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.$root.$on('submitModal', function (formObj) {
            _this.formObj = formObj;
            _this.formObj.notification.className = _this.selectedNotification.className;
            _this.formObj.notification.parameters = [];
    ...
    methods: {
        ...
        sendNotification: function sendNotification() {
            ...
            this.selectedNotification.fields.forEach(function (field) {
            ...
            try {
                for (var _iterator = fieldData.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var _ref = _step.value;

                    var _ref2 = _slicedToArray(_ref, 2);

                    var fieldName = _ref2[0];
                    var fieldValue = _ref2[1];

                    this.formObj.notification.parameters.push(_defineProperty({}, fieldName, fieldValue));
                }
            } catch (err) {
            ...
            Nova.request().post('/nova-vendor/nova-notifications/notifications/send', this.formObj).then(function (response) {
                ...
                if (error.response.status == 422) {
                    _this4.validationErrors = new __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Errors"](error.response.data.errors);
                } else {
                    console.log(error);
                    _this4.resetForm();
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NotificationParamForm__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NotificationModalFooter__ = __webpack_require__(37);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getNotifiableItems: function getNotifiableItems(className) {
            return _.find(this.notifiables, { className: className }).options;
        },
        getNotifiableName: function getNotifiableName(className) {
            return _.find(this.notifiables, { className: className }).name;
        },
        setDetaultNotifiable: function setDetaultNotifiable() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__NotificationParamInput__ = __webpack_require__(33);
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mt-6 mb-6", attrs: { level: 2 } }, [
        _vm._v(_vm._s(_vm.__("Send Notification To")))
      ]),
      _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        handleSubmit: function handleSubmit() {
            this.$root.$emit('submitModal', this.formObj);
        },
  ...
  return _c("div", { staticClass: "bg-30 px-6 py-3 flex" }, [
    _c("div", { staticClass: "ml-auto" }, [
      ...
      _c(
        ...
        [_c("span", [_vm._v(_vm._s(_vm.__("Send")))])]
      )
    ])
  ])
}
    ...
    ? _c("modal", [
        _c(
          ...
          [
            _c(
              ...
              [
                ...
                _vm.notifiables.length > 1
                      ...
                      _c("div", { staticClass: "md:w-2/3" }, [
                        _c("div", { staticClass: "relative" }, [
                          _c(
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.formObj.notifiable.className,
                                  expression: "formObj.notifiable.className"
                                }
                              ],
                              staticClass:
                                "block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey",
                            ...
                            _vm._l(_vm.notifiables, function(notifiable) {
                              return _c(
                                "option",
                                { domProps: { value: notifiable.className } },
                                [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(notifiable.name) +
                                      "\n                            "
                                  )
                                ]
                              )
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.formObj.notifiable.className &&
                !_vm.formObj.notifiable.sendToAll
                  ? _c("div", { staticClass: "md:flex md:items-center mb-6" }, [
                      _c("div", { staticClass: "md:w-1/3" }, [
                        _c(
                          "label",
                ...
                _vm.formObj.notifiable.className
                  ? _c("div", { staticClass: "md:flex md:items-center mb-6" }, [
                      ...
                      _c(
                        ...
                        [
                          _c("checkbox", {
                            attrs: {
                              checked: _vm.formObj.notifiable.sendToAll
                            },
                            on: {
                              input: function($event) {
                                _vm.formObj.notifiable.sendToAll = !_vm.formObj
                                  .notifiable.sendToAll
                              }
                            }
                          })
                        ],
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.hasNoSelectedNotifiableError
                  ? _c("p", { staticClass: "my-2 text-danger" }, [
                      _vm._v(
                        "Please select to who or what you'd like to sent the notifiable to."
                      )
                    ])
                  : _vm._e(),
                _vm._v(" "),
                _vm.selectedNotification.fields.length
                  ? _c(
                      "heading",
                      { staticClass: "mt-6 mb-6", attrs: { level: 2 } },
                      [
                        _vm._v(
                          "\n                " +
                            _vm._s(_vm.__("Define Notification Parameters")) +
                            "\n            "
                        )
                      ]
                    )
                  : _vm._e(),
                _vm._v(" "),
                _vm._l(_vm.selectedNotification.fields, function(field) {
                  return _vm.selectedNotification.fields.length
                    ? _c(
                        "div",
                        [
            ...
            _vm._v(" "),
            _c("notification-modal-footer", { attrs: { formObj: _vm.formObj } })
          ],
          1
        )
      ])
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v(_vm._s(_vm.__("Send Notification")))
      ]),
      _vm._v(" "),
      _vm.selectedNotification
        ? _c("notifications-param-modal", {
            attrs: {
              ...
              hasNoSelectedNotifiableError: _vm.hasNoSelectedNotifiableError
            }
          })
        : _vm._e(),
      _vm._v(" "),
        ...
        [
          _vm.notificationClasses.length
            ? _c(
                "table",
                {
                  staticClass: "table w-full text-left",
                  attrs: { cellpadding: "0", cellspacing: "0" }
                },
                [
                  _c("thead", [
                    _c("tr", [
                      ...
                      _vm._v(" "),
                      _c("th", [_vm._v(_vm._s(_vm.__("Parameters")))]),
                      _vm._v(" "),
                      _c("th")
                    ])
                  ]),
                      ...
                      return _c("tr", [
                        _c("td", { staticClass: "py-2" }, [
                          _c("span", { staticClass: "font-bold" }, [
                            _vm._v(_vm._s(notificationClass.name))
                          ]),
                          _c("br"),
                          _vm._v(" "),
                          _c("span", { staticClass: "text-xs text-80" }, [
                            _vm._v(_vm._s(notificationClass.className))
                          ])
                        ]),
                        _vm._v(" "),
                        _c(
                          "td",
                          { staticClass: "py-2" },
                          _vm._l(notificationClass.parameters, function(
                            param,
                            index
                          ) {
                            return _c("span", { key: index }, [
                              _c("span", [_vm._v(_vm._s(param.displayName))]),
                              index + 1 < notificationClass.parameters.length
                                ? _c("span", [_vm._v(", ")])
                                : _vm._e()
                            ])
                          }),
                        ...
                        _vm._v(" "),
                        _c("td", { staticClass: "text-right py-2" }, [
                          _c(
                            "button",
                            {
                              staticClass: "btn btn-default btn-primary",
            ...
            : _c("div", [
                _c("p", { staticClass: "m-4" }, [
                  _vm._v(
                    _vm._s(
                      _vm.__("You don't have any notification classes yet.")
                    )
                  )
                ])
              ])
