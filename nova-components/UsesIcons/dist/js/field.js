...
Nova.booting(function (Vue, router) {
    Vue.component('index-uses-icons', __webpack_require__(3));
    Vue.component('detail-uses-icons', __webpack_require__(16));
    Vue.component('form-uses-icons', __webpack_require__(19));
});
...
var update = __webpack_require__(7)("02b2c220", content, false, {});
...
// module
exports.push([module.i, "\n.icons[data-v-9e63f81a] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  list-style: none;\n  margin: 0 -5px;\n  padding: 0;\n}\n.icons__icon[data-v-9e63f81a] {\n    opacity: 0.3;\n    margin: 0 5px;\n    border-radius: 50%;\n    overflow: hidden;\n}\n.icons__icon--active[data-v-9e63f81a] {\n    opacity: 1;\n}\n", ""]);
...
exports.default = {
    ...
    methods: {
        getInitialIcons: function getInitialIcons() {
            if (this.field.value) {
...
var _vuedraggable = __webpack_require__(13);
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.field.fill = function (formData) {
            formData.append(_this.field.attribute, _this.getAsJson());
        };
    },
    ...
    methods: {
        ...
        getAsJson: function getAsJson() {
            this.updatePositionProperties();

            return (0, _stringify2.default)(this.icons);
        },
        updatePositionProperties: function updatePositionProperties() {
            if (this.icons) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("48e4f680", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
// module
exports.push([module.i, "\n.icons[data-v-c023248a] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  list-style: none;\n  margin: 0 -5px;\n  padding: 0;\n}\n.icons__icon[data-v-c023248a] {\n    opacity: 0.3;\n    margin: 0 5px;\n    border-radius: 50%;\n    overflow: hidden;\n    cursor: move;\n}\n.icons__icon--active[data-v-c023248a] {\n    opacity: 1;\n}\n", ""]);
