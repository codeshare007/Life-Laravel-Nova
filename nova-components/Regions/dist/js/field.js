...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-regions', __webpack_require__(3));
    Vue.component('detail-regions', __webpack_require__(6));
    Vue.component('form-regions', __webpack_require__(9));
});
...
exports.default = {
    ...
    methods: {
        description: function description() {
            ...
            return this.field.region_options.map(function (option) {
                if (_this.field.value.includes(option.value)) {
...
var render = function() {
  ...
  return _vm.editMode
    ? _c("form-" + _vm.field.component, {
        tag: "component",
        attrs: { "resource-name": _vm.resourceName, field: _vm.field },
        on: {
    ...
    : _c("div", [_c("span", [_vm._v(_vm._s(_vm.description()))])])
}
var staticRenderFns = []
...
var _laravelNova = __webpack_require__(14);
...
exports.default = {
    ...
    methods: {
        ...
        fill: function fill(formData) {
            formData.append(this.field.attribute, (0, _stringify2.default)(this.value || []));
        },
        toggleOption: function toggleOption(optionValue) {
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          { staticClass: "region-option-buttons" },
          _vm._l(_vm.field.region_options, function(option) {
            return _c(
              "button",
              {
                key: option.value,
                staticClass: "region-option-button",
                class: {
                  "region-option-button--active": _vm.selectedRegions.includes(
                    option.value
                  )
                },
                attrs: { type: "button" },
